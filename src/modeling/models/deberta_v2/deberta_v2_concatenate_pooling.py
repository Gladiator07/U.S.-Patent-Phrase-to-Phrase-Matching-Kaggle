...
class DebertaV2ConcatenatePooling(DebertaV2PreTrainedModel):
    def __init__(
        self,
        config,
        loss_type: str = "mse",
        ...
        self.output = nn.Linear(config.hidden_size * 4, num_labels)
    ...
    def forward(
        ...
        logits = self.output(self.dropout(concatenate_pooling))
