...
from modeling.mixins import TransformerHead, CorrLoss


class DebertaV2ForSequenceClassificationTransformerHead(DebertaV2PreTrainedModel):
    def __init__(
        self,
        config,
        loss_type: str = "mse",
        ...
        self.output = nn.Linear(133, num_labels)
    ...
    def forward(
        ...
        feature = self.transformer_head(last_hidden_states)
        logits = self.output(self.dropout(feature))
